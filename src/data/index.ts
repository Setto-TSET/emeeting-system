...
export const meetings: Meeting[] = [
  ...
  },
  {
    ...
    displayFormat: 2,
    participants: [
      { id: "P-Z1", name: "นาย สมชาย ใจดี", position: "ประธาน", role: "Project Manager", department: "สำนักบริหาร", userId: "U-001", email: "somchai.j@e-office.cloud", inSystem: true, present: true },
      { id: "P-Z2", name: "นางสาว มาลี รักษาสัตย์", position: "กรรมการ", role: "เลขานุการ", department: "สำนักผู้บริหาร", userId: "U-003", email: "malee.r@e-office.cloud", inSystem: true, present: true },
      { id: "P-Z3", name: "นาย ประเสริฐ มั่นคง", position: "กรรมการ", role: "ผู้อำนวยการ", department: "สำนักผู้บริหาร", userId: "U-002", email: "prasert@e-office.cloud", inSystem: true, present: false },
    ],
    files: [],
    agenda: [
